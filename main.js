...
const showToDos= function(todoList){
    ...
    Array.from(document.querySelectorAll(".delete-todo")).forEach(button=>{
        button.addEventListener("click",function(){
            _logic__WEBPACK_IMPORTED_MODULE_2__.MyProjects.projects[this.dataset.project].todos.splice(1,this.dataset.id);
